---
name: attack-concurrency
description: Generate real interleavings for ordering, lease, and retry races.
effort: max
...
Generate real interleavings for ordering, lease, and retry races.
