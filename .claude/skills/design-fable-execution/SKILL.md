---
name: design-fable-execution
description: Create long-horizon state, delegation, recovery, and verification.
effort: max
...
Create long-horizon state, delegation, recovery, and verification.
