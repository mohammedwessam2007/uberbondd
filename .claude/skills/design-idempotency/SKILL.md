---
name: design-idempotency
description: Define idempotency keys, deduplication, and retry semantics.
effort: max
...
Define idempotency keys, deduplication, and retry semantics.
