---
name: design-negative-tests
description: Design denial, stale, malformed, and missing-evidence tests.
effort: max
...
Design denial, stale, malformed, and missing-evidence tests.
