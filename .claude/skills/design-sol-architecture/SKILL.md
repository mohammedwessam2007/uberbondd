---
name: design-sol-architecture
description: Create architecture, invariants, counterfactuals, and acceptance.
effort: max
...
Create architecture, invariants, counterfactuals, and acceptance.
