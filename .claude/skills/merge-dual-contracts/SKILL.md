---
name: merge-dual-contracts
description: Merge compatible Fable and Sol artifacts under arbitration rules.
effort: max
...
Merge compatible Fable and Sol artifacts under arbitration rules.
