---
name: review-sol-lens
description: Review architecture, counterfactuals, bypasses, and final completeness.
effort: max
...
Review architecture, counterfactuals, bypasses, and final completeness.
