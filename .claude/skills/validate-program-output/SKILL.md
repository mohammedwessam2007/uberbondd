---
name: validate-program-output
description: Validate program schema, counts, hashes, and completeness.
effort: high
...
Validate program schema, counts, hashes, and completeness.
