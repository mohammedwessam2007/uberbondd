...
SOVEREIGN SELF
  ...
  -> UBERBOND COMPANY / SOFTWARE / AI / DISTRIBUTION / PAYMENT / DELIVERY / SELF-IMPROVEMENT
```

The Personal Civilization Engine remains fully preserved as the highest contained life-system organism. The economic company remains a powerful subordinate organ whose operational objective is still:

`risk-adjusted cleared contribution profit / founder minute`

## What happened to the website-audit system?

Nothing was deleted.

The original Revenue Engine, website-audit, outreach, paid-report, monitoring, lead-path evidence, distribution, payment, and fulfilment machinery remains part of UberBond's historical and operational economic organism. It is **not the definition of UberBond**.

The previous root README is preserved byte-for-byte at:

[`docs/history/README_REVENUE_ENGINE_1_4_2026-07.md`](docs/history/README_REVENUE_ENGINE_1_4_2026-07.md)

Use that historical document when you specifically need the July Revenue Engine 1.4 instructions.
...
North Star canon is **not** proof of implementation.

For present-tense claims, prefer:

1. current `main` code;
2. exact-head verification receipts;
3. durable external provider/customer/world evidence;
4. observed outcomes;
