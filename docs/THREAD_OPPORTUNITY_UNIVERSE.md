...
- a user-thread provenance reference;
- a bounded seven-day local experiment;
- a generic Task Universe blueprint;
- a kill condition;
...
DISCOVERED -> EVIDENCED -> PROPOSED -> BUILT -> VERIFIED -> SHADOW -> CANARY -> ECONOMICALLY_PROVEN -> PROMOTED

No thread-derived candidate can skip the evidence and payment gates.
