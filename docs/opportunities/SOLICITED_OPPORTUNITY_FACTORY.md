...
The current active experiment is frozen at the first step. Its buyer-facing scope, payment-before-fulfilment rule, acceptance window, revision/refund boundaries, and kill conditions are defined in [`WEBSITE_QA_DIAGNOSTIC_OFFER_CONTRACT_2026-08-13.md`](WEBSITE_QA_DIAGNOSTIC_OFFER_CONTRACT_2026-08-13.md). The truthful demonstration and delivery procedure are in the [`buyer-proof pack`](QA_DIAGNOSTIC_BUYER_PROOF_PACK_2026-08-13.md) and [`delivery/acceptance SOP`](WEBSITE_QA_DIAGNOSTIC_DELIVERY_ACCEPTANCE_SOP_2026-08-13.md).

Do not progress to the proof pilot or monthly wholesale lane until the first diagnostic has a cleared payment, delivered report, acceptance/correction record, and owner review.
