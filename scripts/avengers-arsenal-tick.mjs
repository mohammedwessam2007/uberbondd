...
async function main() {
  ...
  const planInput = readAvengersArtifact(planPath, {
    kind: 'plan',
    producedBy: 'npm run avengers:plan',
    describes: 'The squad plan'
  });
  if (!planInput.ok) { console.error(JSON.stringify(planInput, null, 2)); return 2; }
