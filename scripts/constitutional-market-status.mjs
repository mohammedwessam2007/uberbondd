...
const result={
  ok:[parent,attenuation,graph,revocation,proofDag,ancestry,cell,founder,strategy,external].every(row=>row?.ok===true),
  ...
  capabilities:{
    ...
    mechanismMarket:typeof runFrontierTaskTournament==='function',
  ...
  truthBoundary:'READ_ONLY_OPERATOR_DOCTOR__NO_PROVIDER_CALLS_NO_EXTERNAL_EFFECTS_NO_PROMOTION_AUTHORITY'
};
