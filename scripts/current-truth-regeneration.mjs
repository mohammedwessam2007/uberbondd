...
export function executeCurrentTruthRegeneration(){
 ...
 const coverageRun=run('node',['scripts/sovereign-coverage-terminal-closure.mjs']);if(coverageRun.exitCode!==0)return{ok:false,status:'CURRENT_TRUTH_REGENERATION_REFUSED',reasonCodes:['coverage-generator-failed'],generatorResults:{readiness:readinessRun,coverage:coverageRun},businessEffectAuthority:'NONE'};
