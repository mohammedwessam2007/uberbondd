...
export function executeCurrentTruthRegeneration(){
 ...
 return verifyCurrentTruthRegenerationWithReferenceIntegrity({headSha,readiness,coverage,leafGraph,freeze,trackedPaths:tracked,dirtyPaths:newlyDirtyPaths(before,after||[]),generatorResults:{readiness:readinessRun,coverage:coverageRun,leafGraph:leafGraphRun}});
}
