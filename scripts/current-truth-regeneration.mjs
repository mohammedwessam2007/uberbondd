...
export function executeCurrentTruthRegeneration(){
 ...
 return verifyCurrentTruthRegenerationWithReferenceIntegrity({headSha,readiness,coverage,leafGraph,freeze,trackedPaths:tracked,dirtyPaths:newlyDirtyPaths(before,after||[]),truthInputCheckoutCleanBeforeRegeneration:true,generatorResults:{readiness:readinessRun,coverage:coverageRun,leafGraph:leafGraphRun}});
}
