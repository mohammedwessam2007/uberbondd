...
const requiredUber=['UBERMESH','UBERCLOUD','UBERGRAPH','UBERMIND','UBERDNA','UBERMEMORY','UBERVAULT','UBERRUNTIME','UBERCONTROL','UBERAGENTS','UBERMODELS','UBERRESEARCH','UBERECONOMY','UBERPAY','UBERMAIL','UBERDELIVERY'];
...
const probes={
  ...
  computeCells:allocateSovereignCells({requirements:[{resourceType:'EXECUTION',dataClass:'SOURCE_CODE',requiredTags:['node20'],units:1}],cells:[doctorCell('doctor-local','owned-a')],maxTotalCostCents:0}),
  uberCloud:compileUberCloudPlan({serviceId:'doctor-continuum',requirements:[{requirementId:'runtime',resourceType:'EXECUTION',dataClass:'SOURCE_CODE',requiredTags:['node20'],units:1}],cells:[doctorCell('doctor-owned','owned-a'),doctorCell('doctor-open','open-b')],meshReceipt:{providerIndependent:true,transport:'WIREGUARD',evidenceRef:'receipt:doctor:synthetic-ubermesh'},maxTotalCostCents:0}),
