...
const REGISTRY = Object.freeze([
  ...
  { id: 'ubermail-agent-api', name: 'Owned UberMail Agent API (private AgentMail-like control plane)', status: 'TEST_VERIFIED',
    dependencies: [], testRefs: ['tests/ubermail-agent-api.test.mjs', 'tests/ubermail-agent-http.test.mjs', 'tests/ubermail-uberdoso-bridge.test.mjs'],
    productionReadiness: 'Clean-room private mailbox API is implemented and deterministically tested: keys, pods, domains, inboxes, messages/replies/forwards, search, threads, drafts/scheduling, attachments, webhooks, lists, inbound ingestion, durable state and a governed UberDoso bridge. It does not claim a live Postal host, DNS, reputation, or provider acceptance.',
    notes: 'src/ubermail-agent-api.mjs, src/ubermail-agent-http.mjs, src/ubermail-file-repository.mjs, src/ubermail-uberdoso-bridge.mjs' },
