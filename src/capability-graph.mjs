...
const REGISTRY = Object.freeze([
  ...
  { id: 'provider-adapter-contract', name: 'Provider adapter contract and Icemail/Mailforge infrastructure clients', status: 'TEST_VERIFIED',
    dependencies: [], testRefs: ['tests/domain-mailbox-readiness.test.mjs', 'tests/provider-http-adapters.test.mjs'],
    productionReadiness: 'Documented Icemail and Mailforge infrastructure routes are implemented behind injectable HTTP adapters with secret rejection, read retry limits, mutation approval, idempotency and unknown-outcome recovery. No provider credential is configured on this branch, so no live provider state is claimed.',
    notes: 'src/provider-adapter-contract.mjs, src/provider-http-adapters.mjs' },
