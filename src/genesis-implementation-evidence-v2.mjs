...
export const GENESIS_IMPLEMENTATION_EVIDENCE_V2_VERSION = 'uberbond.genesis-implementation-evidence-v2-1.1.0';
...
const ventureOrganism = normalizeVentureEvidence();
...
export const GENESIS_IMPLEMENTATION_EVIDENCE=mergePacks(FOUNDATION_EVIDENCE,economicPhysics,ventureOrganism);
