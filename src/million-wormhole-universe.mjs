...
export function renderMillionWormholeCandidate(index){
  ...
  return {index,id:`mw-${id}`,organ,operator:MILLION_WORMHOLE_OPERATORS[a.operatorId],substrate:SUBSTRATES[a.substrateId],verification:VERIFIERS[a.verifierId],status:'HYPOTHESIS',businessEffectAuthority:'NONE',externalEffectAuthority:'NONE'};
}
