...
export const OMEGA_DIMENSIONS = Object.freeze([
  ...
  { id: 'N08', name: 'MULTI_GENERATION_SELF_IMPROVEMENT',
    ...
    runtimeReceipts: ['artifacts/nullstar-omega/generations/G2.json', 'artifacts/nullstar-omega/generations/G3.json', 'artifacts/nullstar-omega/generations/G4.json'] },
  { id: 'N09', name: 'META_IMPROVEMENT',
    modules: ['src/recursive-improvement-retention.mjs', 'src/nullstar-omega-meta-improvement.mjs', 'src/nullstar-omega-software-outcome.mjs'],
    tests: ['tests/recursive-improvement-retention.test.mjs', 'tests/nullstar-omega-meta-improvement.test.mjs', 'tests/nullstar-omega-software-outcome.test.mjs'],
