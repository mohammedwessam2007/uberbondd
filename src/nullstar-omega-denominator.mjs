...
export const OMEGA_DIMENSIONS = Object.freeze([
  ...
  { id: 'N08', name: 'MULTI_GENERATION_SELF_IMPROVEMENT',
    ...
    runtimeReceipts: ['artifacts/nullstar-omega/generations/G2.json', 'artifacts/nullstar-omega/generations/G3.json', 'artifacts/nullstar-omega/generations/G4.json', 'artifacts/nullstar-omega/generations/G5.json'] },
