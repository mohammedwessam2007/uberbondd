...
export const OWNER_USE_CASE_JOBS = Object.freeze([
  ...
  { id: 'sender_infrastructure', label: 'Sender fleet and rotation', weight: 4, instantly: 5, uberbond: 4, winner: 'Instantly', basis: 'UberBond now owns encrypted arbitrary SMTP fleet custody, health-ranked sticky allocation and provider-neutral dispatch; the external mailbox/reputation substrate itself still has to be acquired and observed' },
  ...
  { id: 'placement', label: 'Inbox placement and blacklist testing', weight: 3, instantly: 5, uberbond: 4, winner: 'Instantly', basis: 'UberBond now owns UberPlacement seed-test planning, observation aggregation and UberWarm ingestion; real recipient-network seed inboxes remain external substrate' },
...
export const COMPARISON_FUNCTIONAL_SECTORS = Object.freeze([
  ...
  },
  {
    id: 'sender_and_deliverability', label: 'Sender infrastructure and deliverability', description: 'How each system protects the sending channel and manages delivery uncertainty.', dimensions: [
      comparisonDimension({ id: 'sender_fleet', label: 'Connected sender fleet', weight: 5, instantly: 5, uberbond: 2, basis: 'Instantly has the larger account and warmup operation; UberBond has bounded owner-controlled slots.', instantlyEvidence: 'Unlimited connected accounts and warmup are documented.', uberbondEvidence: 'Encrypted arbitrary SMTP fleets, Gmail/Postal compatibility, sender registries, caps, health routing and owner controls are implemented; live provider substrate remains external.', confidence: 'official-capability-plus-implementation' }),
  ...
  },
  {
    id: 'conversation_and_automation', label: 'Conversation, automation and AI', description: 'How each system handles replies, workflow events and machine assistance.', dimensions: [
      comparisonDimension({ id: 'unified_inbox', label: 'Unified inbox', weight: 4, instantly: 4, uberbond: 4, basis: 'Both provide a unified reply surface; UberBond now adds forwarding-inbox ingestion, evidence, bounded reply taxonomy and commercial continuity context.', instantlyEvidence: 'Unibox and reply APIs are documented.', uberbondEvidence: 'Stored threads, UberIMAP forwarding ingestion, bounded UberReply taxonomy, evidence, suppression and opportunity context are implemented.', confidence: 'official-capability-plus-implementation' }),
