...
export const SOVEREIGN_EXPANSION_LENSES = Object.freeze([
  ...
  lens('environment-compiler', 'Environment Compiler', 'Treat rooms, devices and surroundings as configurable cognitive and physical infrastructure.', ['HOW_SHOULD_THE_ENVIRONMENT_CHANGE_FOR_THE_CURRENT_MODE', 'WHAT_CAN_BE_PREPARED_BEFORE_MOHAMED_NOTICES_THE_NEED', 'WHAT_PART_OF_THE_INTERFACE_CAN_MOVE_INTO_THE_ENVIRONMENT']),
  lens('new-sense', 'New Sense Generator', 'Translate hidden variables into intuitive sensory channels rather than dashboards.', ['WHAT_VARIABLE_SHOULD_MOHAMED_BE_ABLE_TO_FEEL', 'WHAT_EXISTING_SENSORY_CHANNEL_CAN_CARRY_IT_WITH_LOW_ATTENTION_COST', 'WHAT_TRAINING_WOULD_TURN_A_SIGNAL_INTO_AN_INTUITIVE_SENSE']),
  ...
  lens('identity-polymorphism', 'Identity Polymorphism', 'Preserve multiple authentic modes of one person rather than compressing Mohamed into one optimized identity.', ['WHICH_AUTHENTIC_MODE_OF_MOHAMED_IS_RELEVANT_HERE', 'WHICH_MODE_IS_BEING_STARVED_BY_CURRENT_ENVIRONMENT', 'HOW_CAN_MULTIPLE_IDENTITIES_COMPOUND_WITHOUT_BECOMING_A_PRISON']),
  lens('desire-horizon', 'Desire Horizon', 'Search for valuable possibilities Mohamed may not yet know enough to want.', ['WHAT_WORTHWHILE_POSSIBILITY_IS_OUTSIDE_CURRENT_EXPERIENCE', 'WHAT_EXPOSURE_COULD_REVEAL_A_NEW_PREFERENCE_WITHOUT_MANUFACTURING_IT', 'WHICH_DESIRES_SHOULD_REMAIN_UNTOUCHED']),
  lens('future-self-parliament', 'Future-Self Parliament', 'Represent consequences for materially different future versions of Mohamed.', ['WHICH_FUTURE_SELF_BENEFITS_OR_PAYS_FOR_THIS_CHOICE', 'WHICH_BRANCH_WOULD_REGRET_IRREVERSIBILITY', 'WHAT_OPTION_PRESERVES_DIALOGUE_WITH_MORE_FUTURE_SELVES']),
  lens('intertemporal-bridge', 'Intertemporal Bridge', 'Connect past evidence, current will and future possibility without giving historical selves authority over the present.', ['WHAT_DID_PAST_MOHAMED_KNOW_THAT_CURRENT_MOHAMED_FORGOT', 'WHAT_CAN_CURRENT_MOHAMED_LEAVE_FOR_FUTURE_MOHAMED', 'WHICH_LONGITUDINAL_PATTERN_IS_ONLY_VISIBLE_ACROSS_YEARS']),
  ...
  lens('memory-worlds', 'Memory Worlds', 'Reconstruct historically grounded past cognitive contexts rather than returning isolated records.', ['WHAT_DID_THE_WORLD_AND_MOHAMED_LOOK_LIKE_AT_THAT_TIME', 'WHAT_WAS_UNKNOWN_THEN_THAT_IS_OBVIOUS_NOW', 'WHICH_LATER_NARRATIVE_IS_CONTAMINATING_THE_RECONSTRUCTION']),
  ...
  lens('uncopyable-coevolution', 'Uncopyable Coevolution', 'Seek value from longitudinal founder-specific adaptation rather than secrecy or static software alone.', ['WHAT_IMPROVEMENT_REQUIRES_YEARS_OF_PERSONAL_EVIDENCE', 'WHAT_CAN_A_COMPETITOR_COPY_TOMORROW', 'WHAT_COMPOUNDS_ONLY_THROUGH_MOHAMED_UBERBOND_COEVOLUTION']),
