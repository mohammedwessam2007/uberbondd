...
export const SYSTEM_LEVEL_ASI_EVIDENCE_VERSION = 'uberbond.system-level-asi-evidence.v1.1';
...
function normalizeDimension(row,nowMs,maxAgeMs,candidateId,candidateRevision){
  ...
  return{dimension,evidenceRef,independentEvaluatorRef:evaluatorRef,verifierId,verifierLineageRef,taskPopulationHash,observedAt:observed.raw,compositionDigest:c13.compositionDigest,c13ReceiptHash:c13.receiptHash,contaminationStatus};
}
