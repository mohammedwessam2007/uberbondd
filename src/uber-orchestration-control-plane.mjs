...
export const UBER_ORCHESTRATION_PHASES=Object.freeze([
  ...
  {id:'EXECUTION_SUBSTRATE',layers:['UBEROBSERVE','UBERQUEUE','UBERFORGE','UBERCLOUD','UBEROCEAN','UBERCEL','UBERRUNTIME','UBERCONTROL']},
