...
export const UBERBOND_COGNITIVE_GRAPH_POLICY_VERSION = 'uberbond-cognitive-graph-1.2.0';
...
const CORE_NODES = Object.freeze([
  ...
  ['temporal-foundry', 'TEMPORAL_COMPRESSION', 'Temporal Foundry / Future Raid', 'VERIFIED_CURRENT'],
  ['timeline-topology', 'TIMELINE_TOPOLOGY', 'Timeline Topology / Wormhole Engine', 'VERIFIED_CURRENT'],
  ['sandwich', 'SELF_COMPLETION', 'Sandwich Self-Completion', 'VERIFIED_CURRENT'],
  ['connectome-autopoiesis', 'META_INTEGRATION', 'Connectome Autopoiesis', 'VERIFIED_CURRENT'],
...
const CORE_EDGES = Object.freeze([
  ...
  ['genesis', 'temporal-foundry', 'FEEDS'],
  ['context-spine', 'temporal-foundry', 'SUPPLIES'],
  ['avengers', 'temporal-foundry', 'SUPPLIES'],
  ['temporal-foundry', 'avengers', 'FEEDS'],
  ['max-council', 'temporal-foundry', 'CHALLENGES'],
  ['temporal-foundry', 'max-council', 'FEEDS'],
  ['temporal-foundry', 'timeline-topology', 'FEEDS'],
  ['wallbreaker', 'timeline-topology', 'SUPPLIES'],
  ['avengers', 'timeline-topology', 'CHALLENGES'],
  ['timeline-topology', 'avengers', 'FEEDS'],
  ['max-council', 'timeline-topology', 'CHALLENGES'],
  ['timeline-topology', 'max-council', 'FEEDS'],
  ['timeline-topology', 'sandwich', 'SUPPLIES'],
  ['temporal-foundry', 'sandwich', 'SUPPLIES'],
  ['sandwich', 'avengers', 'FEEDS'],
  ['sandwich', 'max-council', 'FEEDS'],
  ['sandwich', 'self-maintainer', 'ALLOCATES'],
  ['sandwich', 'economic-memory', 'FEEDS'],
  ['truth-evidence', 'connectome-autopoiesis', 'SUPPLIES'],
  ['self-maintainer', 'connectome-autopoiesis', 'PROVES_FOR'],
  ['economic-memory', 'connectome-autopoiesis', 'FEEDBACK_TO'],
  ['connectome-autopoiesis', 'genesis', 'FEEDS'],
  ['connectome-autopoiesis', 'capability-genome', 'FEEDS'],
  ['connectome-autopoiesis', 'avengers', 'SUPPLIES'],
  ['connectome-autopoiesis', 'max-council', 'FEEDS'],
  ['connectome-autopoiesis', 'temporal-foundry', 'FEEDS'],
  ['connectome-autopoiesis', 'timeline-topology', 'FEEDS'],
  ['connectome-autopoiesis', 'sandwich', 'SUPPLIES'],
  ['connectome-autopoiesis', 'economic-memory', 'FEEDS'],
  ['temporal-foundry', 'economic-memory', 'FEEDS'],
  ['timeline-topology', 'economic-memory', 'FEEDS'],
