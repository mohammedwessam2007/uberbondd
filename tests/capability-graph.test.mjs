...
test('the Prometheus economic spine and safe commercial slices are visible in the capability graph', () => {
  for (const id of ['market-signal-registry', 'prometheus-economic-spine', 'commercial-experiment-compiler', 'distribution-channel-registry', 'commercial-outcome-lineage', 'commercial-learning-memory']) {
