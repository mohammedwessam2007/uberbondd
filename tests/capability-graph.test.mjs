...
test('the Prometheus economic spine and safe commercial slices are visible in the capability graph', () => {
  for (const id of ['market-signal-registry', 'prometheus-economic-spine', 'approved-source-rehearsal', 'commercial-experiment-compiler', 'distribution-channel-registry', 'commercial-outcome-lineage', 'commercial-learning-memory', 'task-universe-engine', 'self-upgrade-pipeline', 'prometheus-control-tower', 'agent-relay-bus', 'mechanism-recombination-lab', 'business-model-fitness', 'adapter-contracts', 'capital-allocation-planner']) {
