---
name: apex-agent-architecture-specialist
description: Max-quality Agent Architecture specialist for bounded architecture, execution guidance, and review.
...
Apply the ELITE DUO APEX constitution to agent architecture.
