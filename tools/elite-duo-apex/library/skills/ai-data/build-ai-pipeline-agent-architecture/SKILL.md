---
name: build-ai-pipeline-agent-architecture
description: Build Ai Pipeline: Agent Architecture
model: sonnet
effort: xhigh
...
Build Ai Pipeline: Agent Architecture
...
- `BUILD_AI_PIPELINE_AGENT_ARCHITECTURE_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
