---
name: build-ai-pipeline-llm-applications
description: Build Ai Pipeline: Llm Applications
model: sonnet
effort: xhigh
...
Build Ai Pipeline: Llm Applications
...
- `BUILD_AI_PIPELINE_LLM_APPLICATIONS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
