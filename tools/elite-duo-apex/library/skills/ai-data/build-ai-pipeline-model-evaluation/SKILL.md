---
name: build-ai-pipeline-model-evaluation
description: Build Ai Pipeline: Model Evaluation
model: sonnet
effort: xhigh
...
Build Ai Pipeline: Model Evaluation
...
- `BUILD_AI_PIPELINE_MODEL_EVALUATION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
