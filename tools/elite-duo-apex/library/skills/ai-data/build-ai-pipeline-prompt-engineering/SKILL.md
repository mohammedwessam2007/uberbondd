---
name: build-ai-pipeline-prompt-engineering
description: Build Ai Pipeline: Prompt Engineering
model: sonnet
effort: xhigh
...
Build Ai Pipeline: Prompt Engineering
...
- `BUILD_AI_PIPELINE_PROMPT_ENGINEERING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
