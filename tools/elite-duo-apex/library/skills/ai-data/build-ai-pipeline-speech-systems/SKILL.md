---
name: build-ai-pipeline-speech-systems
description: Build Ai Pipeline: Speech Systems
model: sonnet
effort: xhigh
...
Build Ai Pipeline: Speech Systems
...
- `BUILD_AI_PIPELINE_SPEECH_SYSTEMS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
