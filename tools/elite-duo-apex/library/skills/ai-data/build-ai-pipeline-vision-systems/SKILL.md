---
name: build-ai-pipeline-vision-systems
description: Build Ai Pipeline: Vision Systems
model: sonnet
effort: xhigh
...
Build Ai Pipeline: Vision Systems
...
- `BUILD_AI_PIPELINE_VISION_SYSTEMS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
