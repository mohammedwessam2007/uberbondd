---
name: evaluate-model-system-agent-architecture
description: Evaluate Model System: Agent Architecture
model: sonnet
effort: xhigh
...
Evaluate Model System: Agent Architecture

# Inputs

- mission contract
- Agent Architecture source materials
...
- `EVALUATE_MODEL_SYSTEM_AGENT_ARCHITECTURE_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
