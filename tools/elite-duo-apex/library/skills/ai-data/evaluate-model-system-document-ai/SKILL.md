---
name: evaluate-model-system-document-ai
description: Evaluate Model System: Document Ai
model: sonnet
effort: xhigh
...
Evaluate Model System: Document Ai

# Inputs

- mission contract
- Document Ai source materials
...
- `EVALUATE_MODEL_SYSTEM_DOCUMENT_AI_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
