---
name: evaluate-model-system-embeddings
description: Evaluate Model System: Embeddings
model: sonnet
effort: xhigh
...
Evaluate Model System: Embeddings

# Inputs

- mission contract
- Embeddings source materials
...
- `EVALUATE_MODEL_SYSTEM_EMBEDDINGS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
