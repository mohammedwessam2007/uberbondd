---
name: evaluate-model-system-fine-tuning
description: Evaluate Model System: Fine Tuning
model: sonnet
effort: xhigh
...
Evaluate Model System: Fine Tuning

# Inputs

- mission contract
- Fine Tuning source materials
...
- `EVALUATE_MODEL_SYSTEM_FINE_TUNING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
