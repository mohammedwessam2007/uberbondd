---
name: evaluate-model-system-forecasting
description: Evaluate Model System: Forecasting
model: sonnet
effort: xhigh
...
Evaluate Model System: Forecasting

# Inputs

- mission contract
- Forecasting source materials
...
- `EVALUATE_MODEL_SYSTEM_FORECASTING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
