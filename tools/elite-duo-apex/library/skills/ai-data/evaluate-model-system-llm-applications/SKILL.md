---
name: evaluate-model-system-llm-applications
description: Evaluate Model System: Llm Applications
model: sonnet
effort: xhigh
...
Evaluate Model System: Llm Applications

# Inputs

- mission contract
- Llm Applications source materials
...
- `EVALUATE_MODEL_SYSTEM_LLM_APPLICATIONS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
