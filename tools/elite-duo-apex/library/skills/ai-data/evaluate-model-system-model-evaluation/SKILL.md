---
name: evaluate-model-system-model-evaluation
description: Evaluate Model System: Model Evaluation
model: sonnet
effort: xhigh
...
Evaluate Model System: Model Evaluation

# Inputs

- mission contract
- Model Evaluation source materials
...
- `EVALUATE_MODEL_SYSTEM_MODEL_EVALUATION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
