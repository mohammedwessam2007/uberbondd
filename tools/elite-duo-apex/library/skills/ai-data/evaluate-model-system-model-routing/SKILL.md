---
name: evaluate-model-system-model-routing
description: Evaluate Model System: Model Routing
model: sonnet
effort: xhigh
...
Evaluate Model System: Model Routing

# Inputs

- mission contract
- Model Routing source materials
...
- `EVALUATE_MODEL_SYSTEM_MODEL_ROUTING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
