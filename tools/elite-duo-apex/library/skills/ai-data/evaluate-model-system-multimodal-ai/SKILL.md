---
name: evaluate-model-system-multimodal-ai
description: Evaluate Model System: Multimodal Ai
model: sonnet
effort: xhigh
...
Evaluate Model System: Multimodal Ai

# Inputs

- mission contract
- Multimodal Ai source materials
...
- `EVALUATE_MODEL_SYSTEM_MULTIMODAL_AI_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
