---
name: evaluate-model-system-prompt-engineering
description: Evaluate Model System: Prompt Engineering
model: sonnet
effort: xhigh
...
Evaluate Model System: Prompt Engineering

# Inputs

- mission contract
- Prompt Engineering source materials
...
- `EVALUATE_MODEL_SYSTEM_PROMPT_ENGINEERING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
