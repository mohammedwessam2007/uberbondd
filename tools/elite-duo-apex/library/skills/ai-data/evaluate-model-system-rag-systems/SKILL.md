---
name: evaluate-model-system-rag-systems
description: Evaluate Model System: Rag Systems
model: sonnet
effort: xhigh
...
Evaluate Model System: Rag Systems

# Inputs

- mission contract
- Rag Systems source materials
...
- `EVALUATE_MODEL_SYSTEM_RAG_SYSTEMS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
