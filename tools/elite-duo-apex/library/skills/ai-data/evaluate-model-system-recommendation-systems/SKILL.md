---
name: evaluate-model-system-recommendation-systems
description: Evaluate Model System: Recommendation Systems
model: sonnet
effort: xhigh
...
Evaluate Model System: Recommendation Systems

# Inputs

- mission contract
- Recommendation Systems source materials
...
- `EVALUATE_MODEL_SYSTEM_RECOMMENDATION_SYSTEMS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
