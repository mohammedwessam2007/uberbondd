---
name: evaluate-model-system-reranking
description: Evaluate Model System: Reranking
model: sonnet
effort: xhigh
...
Evaluate Model System: Reranking

# Inputs

- mission contract
- Reranking source materials
...
- `EVALUATE_MODEL_SYSTEM_RERANKING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
