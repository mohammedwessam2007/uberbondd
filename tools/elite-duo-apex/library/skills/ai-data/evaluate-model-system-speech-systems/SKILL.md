---
name: evaluate-model-system-speech-systems
description: Evaluate Model System: Speech Systems
model: sonnet
effort: xhigh
...
Evaluate Model System: Speech Systems

# Inputs

- mission contract
- Speech Systems source materials
...
- `EVALUATE_MODEL_SYSTEM_SPEECH_SYSTEMS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
