---
name: evaluate-model-system-synthetic-data
description: Evaluate Model System: Synthetic Data
model: sonnet
effort: xhigh
...
Evaluate Model System: Synthetic Data

# Inputs

- mission contract
- Synthetic Data source materials
...
- `EVALUATE_MODEL_SYSTEM_SYNTHETIC_DATA_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
