---
name: evaluate-model-system-vision-systems
description: Evaluate Model System: Vision Systems
model: sonnet
effort: xhigh
...
Evaluate Model System: Vision Systems

# Inputs

- mission contract
- Vision Systems source materials
...
- `EVALUATE_MODEL_SYSTEM_VISION_SYSTEMS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
