---
name: build-control-system-budgeting
description: Build Control System: Budgeting
model: sonnet
effort: xhigh
...
Build Control System: Budgeting

# Inputs

- mission contract
- Budgeting source materials
...
- `BUILD_CONTROL_SYSTEM_BUDGETING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
