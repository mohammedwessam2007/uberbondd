---
name: build-control-system-cash-management
description: Build Control System: Cash Management
model: sonnet
effort: xhigh
...
Build Control System: Cash Management

# Inputs

- mission contract
- Cash Management source materials
...
- `BUILD_CONTROL_SYSTEM_CASH_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
