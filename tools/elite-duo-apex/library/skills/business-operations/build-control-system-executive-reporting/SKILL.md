---
name: build-control-system-executive-reporting
description: Build Control System: Executive Reporting
model: sonnet
effort: xhigh
...
Build Control System: Executive Reporting

# Inputs

- mission contract
- Executive Reporting source materials
...
- `BUILD_CONTROL_SYSTEM_EXECUTIVE_REPORTING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
