---
name: build-control-system-financial-modeling
description: Build Control System: Financial Modeling
model: sonnet
effort: xhigh
...
Build Control System: Financial Modeling

# Inputs

- mission contract
- Financial Modeling source materials
...
- `BUILD_CONTROL_SYSTEM_FINANCIAL_MODELING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
