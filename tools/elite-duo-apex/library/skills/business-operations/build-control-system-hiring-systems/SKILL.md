---
name: build-control-system-hiring-systems
description: Build Control System: Hiring Systems
model: sonnet
effort: xhigh
...
Build Control System: Hiring Systems

# Inputs

- mission contract
- Hiring Systems source materials
...
- `BUILD_CONTROL_SYSTEM_HIRING_SYSTEMS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
