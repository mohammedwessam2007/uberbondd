---
name: build-control-system-knowledge-management
description: Build Control System: Knowledge Management
model: sonnet
effort: xhigh
...
Build Control System: Knowledge Management

# Inputs

- mission contract
- Knowledge Management source materials
...
- `BUILD_CONTROL_SYSTEM_KNOWLEDGE_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
