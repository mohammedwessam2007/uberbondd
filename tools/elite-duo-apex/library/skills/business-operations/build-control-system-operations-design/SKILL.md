---
name: build-control-system-operations-design
description: Build Control System: Operations Design
model: sonnet
effort: xhigh
...
Build Control System: Operations Design

# Inputs

- mission contract
- Operations Design source materials
...
- `BUILD_CONTROL_SYSTEM_OPERATIONS_DESIGN_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
