---
name: build-control-system-people-operations
description: Build Control System: People Operations
model: sonnet
effort: xhigh
...
Build Control System: People Operations

# Inputs

- mission contract
- People Operations source materials
...
- `BUILD_CONTROL_SYSTEM_PEOPLE_OPERATIONS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
