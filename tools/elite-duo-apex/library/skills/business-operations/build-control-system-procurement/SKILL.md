---
name: build-control-system-procurement
description: Build Control System: Procurement
model: sonnet
effort: xhigh
...
Build Control System: Procurement

# Inputs

- mission contract
- Procurement source materials
...
- `BUILD_CONTROL_SYSTEM_PROCUREMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
