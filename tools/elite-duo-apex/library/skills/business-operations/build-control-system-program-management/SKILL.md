---
name: build-control-system-program-management
description: Build Control System: Program Management
model: sonnet
effort: xhigh
...
Build Control System: Program Management

# Inputs

- mission contract
- Program Management source materials
...
- `BUILD_CONTROL_SYSTEM_PROGRAM_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
