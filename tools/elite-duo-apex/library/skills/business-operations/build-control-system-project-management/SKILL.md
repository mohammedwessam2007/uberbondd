---
name: build-control-system-project-management
description: Build Control System: Project Management
model: sonnet
effort: xhigh
...
Build Control System: Project Management

# Inputs

- mission contract
- Project Management source materials
...
- `BUILD_CONTROL_SYSTEM_PROJECT_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
