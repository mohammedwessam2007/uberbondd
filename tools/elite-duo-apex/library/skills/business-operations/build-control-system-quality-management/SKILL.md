---
name: build-control-system-quality-management
description: Build Control System: Quality Management
model: sonnet
effort: xhigh
...
Build Control System: Quality Management

# Inputs

- mission contract
- Quality Management source materials
...
- `BUILD_CONTROL_SYSTEM_QUALITY_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
