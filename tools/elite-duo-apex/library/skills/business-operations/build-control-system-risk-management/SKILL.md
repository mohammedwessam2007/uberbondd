---
name: build-control-system-risk-management
description: Build Control System: Risk Management
model: sonnet
effort: xhigh
...
Build Control System: Risk Management

# Inputs

- mission contract
- Risk Management source materials
...
- `BUILD_CONTROL_SYSTEM_RISK_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
