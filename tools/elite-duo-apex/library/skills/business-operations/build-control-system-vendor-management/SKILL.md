---
name: build-control-system-vendor-management
description: Build Control System: Vendor Management
model: sonnet
effort: xhigh
...
Build Control System: Vendor Management

# Inputs

- mission contract
- Vendor Management source materials
...
- `BUILD_CONTROL_SYSTEM_VENDOR_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
