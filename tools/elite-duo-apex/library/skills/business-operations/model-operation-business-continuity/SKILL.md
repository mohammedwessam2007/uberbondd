---
name: model-operation-business-continuity
description: Model Operation: Business Continuity
model: sonnet
effort: xhigh
...
Model Operation: Business Continuity
...
- `MODEL_OPERATION_BUSINESS_CONTINUITY_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
