---
name: model-operation-cash-management
description: Model Operation: Cash Management
model: sonnet
effort: xhigh
...
Model Operation: Cash Management
...
- `MODEL_OPERATION_CASH_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
