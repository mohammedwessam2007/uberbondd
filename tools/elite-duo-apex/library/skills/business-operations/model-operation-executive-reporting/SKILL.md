---
name: model-operation-executive-reporting
description: Model Operation: Executive Reporting
model: sonnet
effort: xhigh
...
Model Operation: Executive Reporting
...
- `MODEL_OPERATION_EXECUTIVE_REPORTING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
