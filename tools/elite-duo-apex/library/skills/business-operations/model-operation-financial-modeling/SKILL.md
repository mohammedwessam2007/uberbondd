---
name: model-operation-financial-modeling
description: Model Operation: Financial Modeling
model: sonnet
effort: xhigh
...
Model Operation: Financial Modeling
...
- `MODEL_OPERATION_FINANCIAL_MODELING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
