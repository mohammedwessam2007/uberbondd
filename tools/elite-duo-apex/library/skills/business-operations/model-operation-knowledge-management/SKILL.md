---
name: model-operation-knowledge-management
description: Model Operation: Knowledge Management
model: sonnet
effort: xhigh
...
Model Operation: Knowledge Management
...
- `MODEL_OPERATION_KNOWLEDGE_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
