---
name: model-operation-operations-design
description: Model Operation: Operations Design
model: sonnet
effort: xhigh
...
Model Operation: Operations Design
...
- `MODEL_OPERATION_OPERATIONS_DESIGN_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
