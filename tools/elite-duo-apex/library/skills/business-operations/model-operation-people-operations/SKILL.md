---
name: model-operation-people-operations
description: Model Operation: People Operations
model: sonnet
effort: xhigh
...
Model Operation: People Operations
...
- `MODEL_OPERATION_PEOPLE_OPERATIONS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
