---
name: model-operation-program-management
description: Model Operation: Program Management
model: sonnet
effort: xhigh
...
Model Operation: Program Management
...
- `MODEL_OPERATION_PROGRAM_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
