---
name: model-operation-project-management
description: Model Operation: Project Management
model: sonnet
effort: xhigh
...
Model Operation: Project Management
...
- `MODEL_OPERATION_PROJECT_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
