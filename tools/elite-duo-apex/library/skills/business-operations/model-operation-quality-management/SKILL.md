---
name: model-operation-quality-management
description: Model Operation: Quality Management
model: sonnet
effort: xhigh
...
Model Operation: Quality Management
...
- `MODEL_OPERATION_QUALITY_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
