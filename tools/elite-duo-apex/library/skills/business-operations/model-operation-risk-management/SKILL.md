---
name: model-operation-risk-management
description: Model Operation: Risk Management
model: sonnet
effort: xhigh
...
Model Operation: Risk Management
...
- `MODEL_OPERATION_RISK_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
