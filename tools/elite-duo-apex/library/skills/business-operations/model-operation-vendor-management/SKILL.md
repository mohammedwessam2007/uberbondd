---
name: model-operation-vendor-management
description: Model Operation: Vendor Management
model: sonnet
effort: xhigh
...
Model Operation: Vendor Management
...
- `MODEL_OPERATION_VENDOR_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
