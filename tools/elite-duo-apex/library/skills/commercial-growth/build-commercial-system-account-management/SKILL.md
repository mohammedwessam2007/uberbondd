---
name: build-commercial-system-account-management
description: Build Commercial System: Account Management
model: sonnet
effort: xhigh
...
Build Commercial System: Account Management

# Inputs

- mission contract
- Account Management source materials
...
- `BUILD_COMMERCIAL_SYSTEM_ACCOUNT_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
