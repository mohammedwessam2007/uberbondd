---
name: build-commercial-system-customer-success
description: Build Commercial System: Customer Success
model: sonnet
effort: xhigh
...
Build Commercial System: Customer Success

# Inputs

- mission contract
- Customer Success source materials
...
- `BUILD_COMMERCIAL_SYSTEM_CUSTOMER_SUCCESS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
