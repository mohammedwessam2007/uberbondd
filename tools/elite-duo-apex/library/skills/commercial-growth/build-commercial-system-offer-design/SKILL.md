---
name: build-commercial-system-offer-design
description: Build Commercial System: Offer Design
model: sonnet
effort: xhigh
...
Build Commercial System: Offer Design

# Inputs

- mission contract
- Offer Design source materials
...
- `BUILD_COMMERCIAL_SYSTEM_OFFER_DESIGN_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
