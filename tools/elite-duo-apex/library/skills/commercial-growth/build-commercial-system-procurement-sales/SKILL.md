---
name: build-commercial-system-procurement-sales
description: Build Commercial System: Procurement Sales
model: sonnet
effort: xhigh
...
Build Commercial System: Procurement Sales

# Inputs

- mission contract
- Procurement Sales source materials
...
- `BUILD_COMMERCIAL_SYSTEM_PROCUREMENT_SALES_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
