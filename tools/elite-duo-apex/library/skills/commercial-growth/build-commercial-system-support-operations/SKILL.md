---
name: build-commercial-system-support-operations
description: Build Commercial System: Support Operations
model: sonnet
effort: xhigh
...
Build Commercial System: Support Operations

# Inputs

- mission contract
- Support Operations source materials
...
- `BUILD_COMMERCIAL_SYSTEM_SUPPORT_OPERATIONS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
