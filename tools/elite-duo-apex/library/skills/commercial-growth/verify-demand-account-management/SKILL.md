---
name: verify-demand-account-management
description: Verify Demand: Account Management
model: sonnet
effort: xhigh
...
Verify Demand: Account Management
...
- `VERIFY_DEMAND_ACCOUNT_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
