---
name: verify-demand-buyer-intelligence
description: Verify Demand: Buyer Intelligence
model: sonnet
effort: xhigh
...
Verify Demand: Buyer Intelligence
...
- `VERIFY_DEMAND_BUYER_INTELLIGENCE_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
