---
name: verify-demand-content-marketing
description: Verify Demand: Content Marketing
model: sonnet
effort: xhigh
...
Verify Demand: Content Marketing
...
- `VERIFY_DEMAND_CONTENT_MARKETING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
