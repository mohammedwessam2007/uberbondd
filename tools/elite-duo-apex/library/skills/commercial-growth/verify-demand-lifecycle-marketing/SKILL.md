---
name: verify-demand-lifecycle-marketing
description: Verify Demand: Lifecycle Marketing
model: sonnet
effort: xhigh
...
Verify Demand: Lifecycle Marketing

# Inputs

- mission contract
- Lifecycle Marketing source materials
...
- `VERIFY_DEMAND_LIFECYCLE_MARKETING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
