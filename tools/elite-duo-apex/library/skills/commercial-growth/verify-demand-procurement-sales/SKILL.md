---
name: verify-demand-procurement-sales
description: Verify Demand: Procurement Sales
model: sonnet
effort: xhigh
...
Verify Demand: Procurement Sales
...
- `VERIFY_DEMAND_PROCUREMENT_SALES_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
