---
name: verify-demand-revenue-operations
description: Verify Demand: Revenue Operations
model: sonnet
effort: xhigh
...
Verify Demand: Revenue Operations

# Inputs

- mission contract
- Revenue Operations source materials
...
- `VERIFY_DEMAND_REVENUE_OPERATIONS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
