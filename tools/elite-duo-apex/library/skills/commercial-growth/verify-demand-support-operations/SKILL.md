---
name: verify-demand-support-operations
description: Verify Demand: Support Operations
model: sonnet
effort: xhigh
...
Verify Demand: Support Operations
...
- `VERIFY_DEMAND_SUPPORT_OPERATIONS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
