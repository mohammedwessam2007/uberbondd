---
name: build-review-packet-ai-governance-prep
description: Build Review Packet: Ai Governance Prep
model: sonnet
effort: xhigh
...
Build Review Packet: Ai Governance Prep

# Inputs

- mission contract
- Ai Governance Prep source materials
...
- `BUILD_REVIEW_PACKET_AI_GOVERNANCE_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
