---
name: build-review-packet-audit-readiness
description: Build Review Packet: Audit Readiness
model: sonnet
effort: xhigh
...
Build Review Packet: Audit Readiness

# Inputs

- mission contract
- Audit Readiness source materials
...
- `BUILD_REVIEW_PACKET_AUDIT_READINESS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
