---
name: build-review-packet-consumer-protection-prep
description: Build Review Packet: Consumer Protection Prep
model: sonnet
effort: xhigh
...
Build Review Packet: Consumer Protection Prep

# Inputs

- mission contract
- Consumer Protection Prep source materials
...
- `BUILD_REVIEW_PACKET_CONSUMER_PROTECTION_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
