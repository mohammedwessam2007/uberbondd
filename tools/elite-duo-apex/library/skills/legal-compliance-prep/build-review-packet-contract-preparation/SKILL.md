---
name: build-review-packet-contract-preparation
description: Build Review Packet: Contract Preparation
model: sonnet
effort: xhigh
...
Build Review Packet: Contract Preparation

# Inputs

- mission contract
- Contract Preparation source materials
...
- `BUILD_REVIEW_PACKET_CONTRACT_PREPARATION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
