---
name: build-review-packet-data-processing-agreements
description: Build Review Packet: Data Processing Agreements
model: sonnet
effort: xhigh
...
Build Review Packet: Data Processing Agreements

# Inputs

- mission contract
- Data Processing Agreements source materials
...
- `BUILD_REVIEW_PACKET_DATA_PROCESSING_AGREEMENTS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
