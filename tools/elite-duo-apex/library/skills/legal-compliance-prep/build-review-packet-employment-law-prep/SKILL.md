---
name: build-review-packet-employment-law-prep
description: Build Review Packet: Employment Law Prep
model: sonnet
effort: xhigh
...
Build Review Packet: Employment Law Prep

# Inputs

- mission contract
- Employment Law Prep source materials
...
- `BUILD_REVIEW_PACKET_EMPLOYMENT_LAW_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
