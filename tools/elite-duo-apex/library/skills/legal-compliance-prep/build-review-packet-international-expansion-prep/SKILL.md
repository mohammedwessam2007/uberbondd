---
name: build-review-packet-international-expansion-prep
description: Build Review Packet: International Expansion Prep
model: sonnet
effort: xhigh
...
Build Review Packet: International Expansion Prep

# Inputs

- mission contract
- International Expansion Prep source materials
...
- `BUILD_REVIEW_PACKET_INTERNATIONAL_EXPANSION_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
