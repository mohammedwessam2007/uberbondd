---
name: build-review-packet-ip-research-prep
description: Build Review Packet: Ip Research Prep
model: sonnet
effort: xhigh
...
Build Review Packet: Ip Research Prep

# Inputs

- mission contract
- Ip Research Prep source materials
...
- `BUILD_REVIEW_PACKET_IP_RESEARCH_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
