---
name: build-review-packet-privacy-compliance-prep
description: Build Review Packet: Privacy Compliance Prep
model: sonnet
effort: xhigh
...
Build Review Packet: Privacy Compliance Prep

# Inputs

- mission contract
- Privacy Compliance Prep source materials
...
- `BUILD_REVIEW_PACKET_PRIVACY_COMPLIANCE_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
