---
name: build-review-packet-record-retention
description: Build Review Packet: Record Retention
model: sonnet
effort: xhigh
...
Build Review Packet: Record Retention

# Inputs

- mission contract
- Record Retention source materials
...
- `BUILD_REVIEW_PACKET_RECORD_RETENTION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
