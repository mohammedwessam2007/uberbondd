---
name: build-review-packet-regulatory-research-prep
description: Build Review Packet: Regulatory Research Prep
model: sonnet
effort: xhigh
...
Build Review Packet: Regulatory Research Prep

# Inputs

- mission contract
- Regulatory Research Prep source materials
...
- `BUILD_REVIEW_PACKET_REGULATORY_RESEARCH_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
