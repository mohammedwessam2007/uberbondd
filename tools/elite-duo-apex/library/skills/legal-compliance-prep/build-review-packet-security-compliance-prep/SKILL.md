---
name: build-review-packet-security-compliance-prep
description: Build Review Packet: Security Compliance Prep
model: sonnet
effort: xhigh
...
Build Review Packet: Security Compliance Prep

# Inputs

- mission contract
- Security Compliance Prep source materials
...
- `BUILD_REVIEW_PACKET_SECURITY_COMPLIANCE_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
