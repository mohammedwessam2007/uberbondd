---
name: build-review-packet-tax-research-prep
description: Build Review Packet: Tax Research Prep
model: sonnet
effort: xhigh
...
Build Review Packet: Tax Research Prep

# Inputs

- mission contract
- Tax Research Prep source materials
...
- `BUILD_REVIEW_PACKET_TAX_RESEARCH_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
