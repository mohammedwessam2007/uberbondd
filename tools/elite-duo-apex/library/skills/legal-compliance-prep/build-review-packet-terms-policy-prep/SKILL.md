---
name: build-review-packet-terms-policy-prep
description: Build Review Packet: Terms Policy Prep
model: sonnet
effort: xhigh
...
Build Review Packet: Terms Policy Prep

# Inputs

- mission contract
- Terms Policy Prep source materials
...
- `BUILD_REVIEW_PACKET_TERMS_POLICY_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
