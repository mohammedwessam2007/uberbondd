---
name: build-review-packet-vendor-due-diligence
description: Build Review Packet: Vendor Due Diligence
model: sonnet
effort: xhigh
...
Build Review Packet: Vendor Due Diligence

# Inputs

- mission contract
- Vendor Due Diligence source materials
...
- `BUILD_REVIEW_PACKET_VENDOR_DUE_DILIGENCE_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
