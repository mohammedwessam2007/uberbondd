---
name: prepare-issue-map-ai-governance-prep
description: Prepare Issue Map: Ai Governance Prep
model: sonnet
effort: xhigh
...
Prepare Issue Map: Ai Governance Prep
...
- `PREPARE_ISSUE_MAP_AI_GOVERNANCE_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
