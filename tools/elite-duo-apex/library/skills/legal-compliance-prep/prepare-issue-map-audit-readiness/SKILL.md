---
name: prepare-issue-map-audit-readiness
description: Prepare Issue Map: Audit Readiness
model: sonnet
effort: xhigh
...
Prepare Issue Map: Audit Readiness
...
- `PREPARE_ISSUE_MAP_AUDIT_READINESS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
