---
name: prepare-issue-map-consumer-protection-prep
description: Prepare Issue Map: Consumer Protection Prep
model: sonnet
effort: xhigh
...
Prepare Issue Map: Consumer Protection Prep
...
- `PREPARE_ISSUE_MAP_CONSUMER_PROTECTION_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
