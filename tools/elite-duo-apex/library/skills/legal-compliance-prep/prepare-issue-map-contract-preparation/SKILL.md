---
name: prepare-issue-map-contract-preparation
description: Prepare Issue Map: Contract Preparation
model: sonnet
effort: xhigh
...
Prepare Issue Map: Contract Preparation
...
- `PREPARE_ISSUE_MAP_CONTRACT_PREPARATION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
