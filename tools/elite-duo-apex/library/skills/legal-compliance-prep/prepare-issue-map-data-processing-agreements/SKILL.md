---
name: prepare-issue-map-data-processing-agreements
description: Prepare Issue Map: Data Processing Agreements
model: sonnet
effort: xhigh
...
Prepare Issue Map: Data Processing Agreements
...
- `PREPARE_ISSUE_MAP_DATA_PROCESSING_AGREEMENTS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
