---
name: prepare-issue-map-employment-law-prep
description: Prepare Issue Map: Employment Law Prep
model: sonnet
effort: xhigh
...
Prepare Issue Map: Employment Law Prep
...
- `PREPARE_ISSUE_MAP_EMPLOYMENT_LAW_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
