---
name: prepare-issue-map-international-expansion-prep
description: Prepare Issue Map: International Expansion Prep
model: sonnet
effort: xhigh
...
Prepare Issue Map: International Expansion Prep
...
- `PREPARE_ISSUE_MAP_INTERNATIONAL_EXPANSION_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
