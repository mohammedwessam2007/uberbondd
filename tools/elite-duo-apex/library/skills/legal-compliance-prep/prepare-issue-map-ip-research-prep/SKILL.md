---
name: prepare-issue-map-ip-research-prep
description: Prepare Issue Map: Ip Research Prep
model: sonnet
effort: xhigh
...
Prepare Issue Map: Ip Research Prep
...
- `PREPARE_ISSUE_MAP_IP_RESEARCH_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
