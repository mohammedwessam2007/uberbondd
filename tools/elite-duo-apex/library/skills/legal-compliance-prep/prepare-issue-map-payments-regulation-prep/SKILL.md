---
name: prepare-issue-map-payments-regulation-prep
description: Prepare Issue Map: Payments Regulation Prep
model: sonnet
effort: xhigh
...
Prepare Issue Map: Payments Regulation Prep
...
- `PREPARE_ISSUE_MAP_PAYMENTS_REGULATION_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
