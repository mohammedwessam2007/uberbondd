---
name: prepare-issue-map-record-retention
description: Prepare Issue Map: Record Retention
model: sonnet
effort: xhigh
...
Prepare Issue Map: Record Retention
...
- `PREPARE_ISSUE_MAP_RECORD_RETENTION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
