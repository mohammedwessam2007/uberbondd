---
name: prepare-issue-map-regulatory-research-prep
description: Prepare Issue Map: Regulatory Research Prep
model: sonnet
effort: xhigh
...
Prepare Issue Map: Regulatory Research Prep
...
- `PREPARE_ISSUE_MAP_REGULATORY_RESEARCH_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
