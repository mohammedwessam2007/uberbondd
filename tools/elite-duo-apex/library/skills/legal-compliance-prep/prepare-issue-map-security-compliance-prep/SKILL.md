---
name: prepare-issue-map-security-compliance-prep
description: Prepare Issue Map: Security Compliance Prep
model: sonnet
effort: xhigh
...
Prepare Issue Map: Security Compliance Prep
...
- `PREPARE_ISSUE_MAP_SECURITY_COMPLIANCE_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
