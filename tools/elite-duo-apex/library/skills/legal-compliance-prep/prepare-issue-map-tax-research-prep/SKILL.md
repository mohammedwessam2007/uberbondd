---
name: prepare-issue-map-tax-research-prep
description: Prepare Issue Map: Tax Research Prep
model: sonnet
effort: xhigh
...
Prepare Issue Map: Tax Research Prep
...
- `PREPARE_ISSUE_MAP_TAX_RESEARCH_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
