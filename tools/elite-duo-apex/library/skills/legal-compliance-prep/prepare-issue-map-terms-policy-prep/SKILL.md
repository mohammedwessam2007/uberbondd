---
name: prepare-issue-map-terms-policy-prep
description: Prepare Issue Map: Terms Policy Prep
model: sonnet
effort: xhigh
...
Prepare Issue Map: Terms Policy Prep
...
- `PREPARE_ISSUE_MAP_TERMS_POLICY_PREP_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
