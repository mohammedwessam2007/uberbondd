---
name: prepare-issue-map-vendor-due-diligence
description: Prepare Issue Map: Vendor Due Diligence
model: sonnet
effort: xhigh
...
Prepare Issue Map: Vendor Due Diligence
...
- `PREPARE_ISSUE_MAP_VENDOR_DUE_DILIGENCE_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
