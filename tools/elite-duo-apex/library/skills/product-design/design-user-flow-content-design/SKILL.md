---
name: design-user-flow-content-design
description: Design User Flow: Content Design
model: sonnet
effort: xhigh
...
Design User Flow: Content Design
...
- `DESIGN_USER_FLOW_CONTENT_DESIGN_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
