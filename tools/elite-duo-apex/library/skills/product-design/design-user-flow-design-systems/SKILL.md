---
name: design-user-flow-design-systems
description: Design User Flow: Design Systems
model: sonnet
effort: xhigh
...
Design User Flow: Design Systems
...
- `DESIGN_USER_FLOW_DESIGN_SYSTEMS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
