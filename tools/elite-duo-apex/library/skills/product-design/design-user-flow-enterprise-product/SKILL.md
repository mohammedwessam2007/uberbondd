---
name: design-user-flow-enterprise-product
description: Design User Flow: Enterprise Product
model: sonnet
effort: xhigh
...
Design User Flow: Enterprise Product
...
- `DESIGN_USER_FLOW_ENTERPRISE_PRODUCT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
