---
name: design-user-flow-experimentation
description: Design User Flow: Experimentation
model: sonnet
effort: xhigh
...
Design User Flow: Experimentation
...
- `DESIGN_USER_FLOW_EXPERIMENTATION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
