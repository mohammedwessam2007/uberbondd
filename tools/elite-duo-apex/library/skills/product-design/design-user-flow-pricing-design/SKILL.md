---
name: design-user-flow-pricing-design
description: Design User Flow: Pricing Design
model: sonnet
effort: xhigh
...
Design User Flow: Pricing Design
...
- `DESIGN_USER_FLOW_PRICING_DESIGN_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
