---
name: design-user-flow-product-discovery
description: Design User Flow: Product Discovery
model: sonnet
effort: xhigh
...
Design User Flow: Product Discovery
...
- `DESIGN_USER_FLOW_PRODUCT_DISCOVERY_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
