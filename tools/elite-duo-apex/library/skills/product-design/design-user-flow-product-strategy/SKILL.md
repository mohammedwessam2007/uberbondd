---
name: design-user-flow-product-strategy
description: Design User Flow: Product Strategy
model: sonnet
effort: xhigh
...
Design User Flow: Product Strategy
...
- `DESIGN_USER_FLOW_PRODUCT_STRATEGY_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
