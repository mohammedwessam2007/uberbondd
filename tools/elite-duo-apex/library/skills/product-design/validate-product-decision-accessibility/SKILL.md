---
name: validate-product-decision-accessibility
description: Validate Product Decision: Accessibility
model: sonnet
effort: xhigh
...
Validate Product Decision: Accessibility

# Inputs

- mission contract
- Accessibility source materials
...
- `VALIDATE_PRODUCT_DECISION_ACCESSIBILITY_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
