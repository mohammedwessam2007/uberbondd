---
name: validate-product-decision-activation
description: Validate Product Decision: Activation
model: sonnet
effort: xhigh
...
Validate Product Decision: Activation
...
- `VALIDATE_PRODUCT_DECISION_ACTIVATION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
