---
name: validate-product-decision-analytics
description: Validate Product Decision: Analytics
model: sonnet
effort: xhigh
...
Validate Product Decision: Analytics

# Inputs

- mission contract
- Analytics source materials
...
- `VALIDATE_PRODUCT_DECISION_ANALYTICS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
