---
name: validate-product-decision-content-design
description: Validate Product Decision: Content Design
model: sonnet
effort: xhigh
...
Validate Product Decision: Content Design

# Inputs

- mission contract
- Content Design source materials
...
- `VALIDATE_PRODUCT_DECISION_CONTENT_DESIGN_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
