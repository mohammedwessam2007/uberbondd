---
name: validate-product-decision-design-systems
description: Validate Product Decision: Design Systems
model: sonnet
effort: xhigh
...
Validate Product Decision: Design Systems

# Inputs

- mission contract
- Design Systems source materials
...
- `VALIDATE_PRODUCT_DECISION_DESIGN_SYSTEMS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
