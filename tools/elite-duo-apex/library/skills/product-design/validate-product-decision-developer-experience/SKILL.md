---
name: validate-product-decision-developer-experience
description: Validate Product Decision: Developer Experience
model: sonnet
effort: xhigh
...
Validate Product Decision: Developer Experience

# Inputs

- mission contract
- Developer Experience source materials
...
- `VALIDATE_PRODUCT_DECISION_DEVELOPER_EXPERIENCE_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
