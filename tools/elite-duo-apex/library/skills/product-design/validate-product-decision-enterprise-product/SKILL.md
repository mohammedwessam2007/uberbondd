---
name: validate-product-decision-enterprise-product
description: Validate Product Decision: Enterprise Product
model: sonnet
effort: xhigh
...
Validate Product Decision: Enterprise Product

# Inputs

- mission contract
- Enterprise Product source materials
...
- `VALIDATE_PRODUCT_DECISION_ENTERPRISE_PRODUCT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
