---
name: validate-product-decision-experimentation
description: Validate Product Decision: Experimentation
model: sonnet
effort: xhigh
...
Validate Product Decision: Experimentation

# Inputs

- mission contract
- Experimentation source materials
...
- `VALIDATE_PRODUCT_DECISION_EXPERIMENTATION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
