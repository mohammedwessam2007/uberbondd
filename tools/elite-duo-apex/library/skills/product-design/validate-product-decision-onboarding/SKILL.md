---
name: validate-product-decision-onboarding
description: Validate Product Decision: Onboarding
model: sonnet
effort: xhigh
...
Validate Product Decision: Onboarding

# Inputs

- mission contract
- Onboarding source materials
...
- `VALIDATE_PRODUCT_DECISION_ONBOARDING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
