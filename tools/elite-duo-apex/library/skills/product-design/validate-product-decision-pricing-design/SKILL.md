---
name: validate-product-decision-pricing-design
description: Validate Product Decision: Pricing Design
model: sonnet
effort: xhigh
...
Validate Product Decision: Pricing Design

# Inputs

- mission contract
- Pricing Design source materials
...
- `VALIDATE_PRODUCT_DECISION_PRICING_DESIGN_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
