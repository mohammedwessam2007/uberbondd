---
name: validate-product-decision-product-discovery
description: Validate Product Decision: Product Discovery
model: sonnet
effort: xhigh
...
Validate Product Decision: Product Discovery

# Inputs

- mission contract
- Product Discovery source materials
...
- `VALIDATE_PRODUCT_DECISION_PRODUCT_DISCOVERY_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
