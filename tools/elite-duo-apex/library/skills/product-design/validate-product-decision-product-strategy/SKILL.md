---
name: validate-product-decision-product-strategy
description: Validate Product Decision: Product Strategy
model: sonnet
effort: xhigh
...
Validate Product Decision: Product Strategy

# Inputs

- mission contract
- Product Strategy source materials
...
- `VALIDATE_PRODUCT_DECISION_PRODUCT_STRATEGY_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
