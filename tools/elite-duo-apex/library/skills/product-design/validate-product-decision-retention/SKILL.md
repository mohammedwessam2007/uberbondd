---
name: validate-product-decision-retention
description: Validate Product Decision: Retention
model: sonnet
effort: xhigh
...
Validate Product Decision: Retention

# Inputs

- mission contract
- Retention source materials
...
- `VALIDATE_PRODUCT_DECISION_RETENTION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
