---
name: validate-product-decision-roadmapping
description: Validate Product Decision: Roadmapping
model: sonnet
effort: xhigh
...
Validate Product Decision: Roadmapping

# Inputs

- mission contract
- Roadmapping source materials
...
- `VALIDATE_PRODUCT_DECISION_ROADMAPPING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
