---
name: validate-product-decision-user-research
description: Validate Product Decision: User Research
model: sonnet
effort: xhigh
...
Validate Product Decision: User Research

# Inputs

- mission contract
- User Research source materials
...
- `VALIDATE_PRODUCT_DECISION_USER_RESEARCH_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
