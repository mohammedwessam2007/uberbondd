---
name: validate-product-decision-ux-design
description: Validate Product Decision: Ux Design
model: sonnet
effort: xhigh
...
Validate Product Decision: Ux Design

# Inputs

- mission contract
- Ux Design source materials
...
- `VALIDATE_PRODUCT_DECISION_UX_DESIGN_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
