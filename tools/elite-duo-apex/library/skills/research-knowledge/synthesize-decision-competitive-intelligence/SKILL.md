---
name: synthesize-decision-competitive-intelligence
description: Synthesize Decision: Competitive Intelligence
model: sonnet
effort: xhigh
...
Synthesize Decision: Competitive Intelligence

# Inputs

- mission contract
- Competitive Intelligence source materials
...
- `SYNTHESIZE_DECISION_COMPETITIVE_INTELLIGENCE_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
