---
name: synthesize-decision-decision-memos
description: Synthesize Decision: Decision Memos
model: sonnet
effort: xhigh
...
Synthesize Decision: Decision Memos

# Inputs

- mission contract
- Decision Memos source materials
...
- `SYNTHESIZE_DECISION_DECISION_MEMOS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
