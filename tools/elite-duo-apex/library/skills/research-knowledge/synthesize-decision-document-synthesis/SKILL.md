---
name: synthesize-decision-document-synthesis
description: Synthesize Decision: Document Synthesis
model: sonnet
effort: xhigh
...
Synthesize Decision: Document Synthesis

# Inputs

- mission contract
- Document Synthesis source materials
...
- `SYNTHESIZE_DECISION_DOCUMENT_SYNTHESIS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
