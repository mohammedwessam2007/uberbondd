---
name: synthesize-decision-evidence-synthesis
description: Synthesize Decision: Evidence Synthesis
model: sonnet
effort: xhigh
...
Synthesize Decision: Evidence Synthesis

# Inputs

- mission contract
- Evidence Synthesis source materials
...
- `SYNTHESIZE_DECISION_EVIDENCE_SYNTHESIS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
