---
name: synthesize-decision-fact-checking
description: Synthesize Decision: Fact Checking
model: sonnet
effort: xhigh
...
Synthesize Decision: Fact Checking

# Inputs

- mission contract
- Fact Checking source materials
...
- `SYNTHESIZE_DECISION_FACT_CHECKING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
