---
name: synthesize-decision-historical-analysis
description: Synthesize Decision: Historical Analysis
model: sonnet
effort: xhigh
...
Synthesize Decision: Historical Analysis

# Inputs

- mission contract
- Historical Analysis source materials
...
- `SYNTHESIZE_DECISION_HISTORICAL_ANALYSIS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
