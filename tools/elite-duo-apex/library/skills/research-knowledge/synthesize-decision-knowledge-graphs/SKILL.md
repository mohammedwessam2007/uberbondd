---
name: synthesize-decision-knowledge-graphs
description: Synthesize Decision: Knowledge Graphs
model: sonnet
effort: xhigh
...
Synthesize Decision: Knowledge Graphs

# Inputs

- mission contract
- Knowledge Graphs source materials
...
- `SYNTHESIZE_DECISION_KNOWLEDGE_GRAPHS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
