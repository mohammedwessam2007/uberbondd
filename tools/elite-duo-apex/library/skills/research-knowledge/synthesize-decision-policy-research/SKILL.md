---
name: synthesize-decision-policy-research
description: Synthesize Decision: Policy Research
model: sonnet
effort: xhigh
...
Synthesize Decision: Policy Research

# Inputs

- mission contract
- Policy Research source materials
...
- `SYNTHESIZE_DECISION_POLICY_RESEARCH_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
