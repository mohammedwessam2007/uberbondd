---
name: synthesize-decision-qualitative-analysis
description: Synthesize Decision: Qualitative Analysis
model: sonnet
effort: xhigh
...
Synthesize Decision: Qualitative Analysis

# Inputs

- mission contract
- Qualitative Analysis source materials
...
- `SYNTHESIZE_DECISION_QUALITATIVE_ANALYSIS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
