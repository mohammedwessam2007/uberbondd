---
name: synthesize-decision-quantitative-analysis
description: Synthesize Decision: Quantitative Analysis
model: sonnet
effort: xhigh
...
Synthesize Decision: Quantitative Analysis

# Inputs

- mission contract
- Quantitative Analysis source materials
...
- `SYNTHESIZE_DECISION_QUANTITATIVE_ANALYSIS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
