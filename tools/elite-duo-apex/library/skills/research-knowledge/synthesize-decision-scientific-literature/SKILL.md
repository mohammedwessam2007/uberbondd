---
name: synthesize-decision-scientific-literature
description: Synthesize Decision: Scientific Literature
model: sonnet
effort: xhigh
...
Synthesize Decision: Scientific Literature

# Inputs

- mission contract
- Scientific Literature source materials
...
- `SYNTHESIZE_DECISION_SCIENTIFIC_LITERATURE_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
