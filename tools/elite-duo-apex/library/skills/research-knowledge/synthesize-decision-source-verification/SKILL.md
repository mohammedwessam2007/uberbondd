---
name: synthesize-decision-source-verification
description: Synthesize Decision: Source Verification
model: sonnet
effort: xhigh
...
Synthesize Decision: Source Verification

# Inputs

- mission contract
- Source Verification source materials
...
- `SYNTHESIZE_DECISION_SOURCE_VERIFICATION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
