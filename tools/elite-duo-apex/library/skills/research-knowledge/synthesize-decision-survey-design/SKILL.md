---
name: synthesize-decision-survey-design
description: Synthesize Decision: Survey Design
model: sonnet
effort: xhigh
...
Synthesize Decision: Survey Design

# Inputs

- mission contract
- Survey Design source materials
...
- `SYNTHESIZE_DECISION_SURVEY_DESIGN_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
