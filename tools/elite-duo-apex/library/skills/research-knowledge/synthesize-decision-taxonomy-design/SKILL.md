---
name: synthesize-decision-taxonomy-design
description: Synthesize Decision: Taxonomy Design
model: sonnet
effort: xhigh
...
Synthesize Decision: Taxonomy Design

# Inputs

- mission contract
- Taxonomy Design source materials
...
- `SYNTHESIZE_DECISION_TAXONOMY_DESIGN_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
