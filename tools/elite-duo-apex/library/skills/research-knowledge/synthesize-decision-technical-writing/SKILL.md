---
name: synthesize-decision-technical-writing
description: Synthesize Decision: Technical Writing
model: sonnet
effort: xhigh
...
Synthesize Decision: Technical Writing

# Inputs

- mission contract
- Technical Writing source materials
...
- `SYNTHESIZE_DECISION_TECHNICAL_WRITING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
