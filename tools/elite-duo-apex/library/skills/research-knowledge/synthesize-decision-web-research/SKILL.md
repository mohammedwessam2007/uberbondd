---
name: synthesize-decision-web-research
description: Synthesize Decision: Web Research
model: sonnet
effort: xhigh
...
Synthesize Decision: Web Research

# Inputs

- mission contract
- Web Research source materials
...
- `SYNTHESIZE_DECISION_WEB_RESEARCH_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
