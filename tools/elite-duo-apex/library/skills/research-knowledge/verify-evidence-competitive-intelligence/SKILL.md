---
name: verify-evidence-competitive-intelligence
description: Verify Evidence: Competitive Intelligence
model: sonnet
effort: xhigh
...
Verify Evidence: Competitive Intelligence
...
- `VERIFY_EVIDENCE_COMPETITIVE_INTELLIGENCE_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
