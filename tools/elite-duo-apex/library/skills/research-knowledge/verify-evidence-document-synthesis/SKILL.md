---
name: verify-evidence-document-synthesis
description: Verify Evidence: Document Synthesis
model: sonnet
effort: xhigh
...
Verify Evidence: Document Synthesis
...
- `VERIFY_EVIDENCE_DOCUMENT_SYNTHESIS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
