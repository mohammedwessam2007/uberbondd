---
name: verify-evidence-evidence-synthesis
description: Verify Evidence: Evidence Synthesis
model: sonnet
effort: xhigh
...
Verify Evidence: Evidence Synthesis
...
- `VERIFY_EVIDENCE_EVIDENCE_SYNTHESIS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
