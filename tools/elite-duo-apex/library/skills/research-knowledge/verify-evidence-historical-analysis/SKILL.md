---
name: verify-evidence-historical-analysis
description: Verify Evidence: Historical Analysis
model: sonnet
effort: xhigh
...
Verify Evidence: Historical Analysis
...
- `VERIFY_EVIDENCE_HISTORICAL_ANALYSIS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
