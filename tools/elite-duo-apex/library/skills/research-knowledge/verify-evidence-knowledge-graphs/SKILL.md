---
name: verify-evidence-knowledge-graphs
description: Verify Evidence: Knowledge Graphs
model: sonnet
effort: xhigh
...
Verify Evidence: Knowledge Graphs
...
- `VERIFY_EVIDENCE_KNOWLEDGE_GRAPHS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
