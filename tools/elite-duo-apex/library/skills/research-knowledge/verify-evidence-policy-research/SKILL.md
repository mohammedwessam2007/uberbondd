---
name: verify-evidence-policy-research
description: Verify Evidence: Policy Research
model: sonnet
effort: xhigh
...
Verify Evidence: Policy Research
...
- `VERIFY_EVIDENCE_POLICY_RESEARCH_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
