---
name: verify-evidence-qualitative-analysis
description: Verify Evidence: Qualitative Analysis
model: sonnet
effort: xhigh
...
Verify Evidence: Qualitative Analysis
...
- `VERIFY_EVIDENCE_QUALITATIVE_ANALYSIS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
