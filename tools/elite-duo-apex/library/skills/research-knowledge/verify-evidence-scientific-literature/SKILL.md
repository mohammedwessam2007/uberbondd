---
name: verify-evidence-scientific-literature
description: Verify Evidence: Scientific Literature
model: sonnet
effort: xhigh
...
Verify Evidence: Scientific Literature
...
- `VERIFY_EVIDENCE_SCIENTIFIC_LITERATURE_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
