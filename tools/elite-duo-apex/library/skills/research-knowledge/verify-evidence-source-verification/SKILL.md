---
name: verify-evidence-source-verification
description: Verify Evidence: Source Verification
model: sonnet
effort: xhigh
...
Verify Evidence: Source Verification
...
- `VERIFY_EVIDENCE_SOURCE_VERIFICATION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
