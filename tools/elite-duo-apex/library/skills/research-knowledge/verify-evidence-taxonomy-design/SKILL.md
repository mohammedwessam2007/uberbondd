---
name: verify-evidence-taxonomy-design
description: Verify Evidence: Taxonomy Design
model: sonnet
effort: xhigh
...
Verify Evidence: Taxonomy Design
...
- `VERIFY_EVIDENCE_TAXONOMY_DESIGN_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
