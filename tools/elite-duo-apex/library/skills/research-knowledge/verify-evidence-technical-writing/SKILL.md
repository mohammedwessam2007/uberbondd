---
name: verify-evidence-technical-writing
description: Verify Evidence: Technical Writing
model: sonnet
effort: xhigh
...
Verify Evidence: Technical Writing
...
- `VERIFY_EVIDENCE_TECHNICAL_WRITING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
