---
name: audit-control-identity-security
description: Audit Control: Identity Security
model: sonnet
effort: xhigh
...
Audit Control: Identity Security
...
- `AUDIT_CONTROL_IDENTITY_SECURITY_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
