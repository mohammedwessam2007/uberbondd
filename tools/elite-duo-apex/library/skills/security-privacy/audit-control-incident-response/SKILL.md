---
name: audit-control-incident-response
description: Audit Control: Incident Response
model: sonnet
effort: xhigh
...
Audit Control: Incident Response
...
- `AUDIT_CONTROL_INCIDENT_RESPONSE_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
