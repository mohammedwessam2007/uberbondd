---
name: audit-control-payments-security
description: Audit Control: Payments Security
model: sonnet
effort: xhigh
...
Audit Control: Payments Security
...
- `AUDIT_CONTROL_PAYMENTS_SECURITY_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
