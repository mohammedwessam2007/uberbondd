---
name: audit-control-secrets-management
description: Audit Control: Secrets Management
model: sonnet
effort: xhigh
...
Audit Control: Secrets Management
...
- `AUDIT_CONTROL_SECRETS_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
