---
name: audit-control-secure-deployment
description: Audit Control: Secure Deployment
model: sonnet
effort: xhigh
...
Audit Control: Secure Deployment
...
- `AUDIT_CONTROL_SECURE_DEPLOYMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
