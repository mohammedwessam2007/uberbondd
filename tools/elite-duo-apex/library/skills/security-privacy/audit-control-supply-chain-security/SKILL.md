---
name: audit-control-supply-chain-security
description: Audit Control: Supply Chain Security
model: sonnet
effort: xhigh
...
Audit Control: Supply Chain Security
...
- `AUDIT_CONTROL_SUPPLY_CHAIN_SECURITY_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
