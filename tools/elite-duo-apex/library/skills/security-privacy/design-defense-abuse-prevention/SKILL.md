---
name: design-defense-abuse-prevention
description: Design Defense: Abuse Prevention
model: sonnet
effort: xhigh
...
Design Defense: Abuse Prevention

# Inputs

- mission contract
- Abuse Prevention source materials
...
- `DESIGN_DEFENSE_ABUSE_PREVENTION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
