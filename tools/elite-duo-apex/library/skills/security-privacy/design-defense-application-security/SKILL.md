---
name: design-defense-application-security
description: Design Defense: Application Security
model: sonnet
effort: xhigh
...
Design Defense: Application Security

# Inputs

- mission contract
- Application Security source materials
...
- `DESIGN_DEFENSE_APPLICATION_SECURITY_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
