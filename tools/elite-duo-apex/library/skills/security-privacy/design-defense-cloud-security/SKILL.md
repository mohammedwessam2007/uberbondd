---
name: design-defense-cloud-security
description: Design Defense: Cloud Security
model: sonnet
effort: xhigh
...
Design Defense: Cloud Security

# Inputs

- mission contract
- Cloud Security source materials
...
- `DESIGN_DEFENSE_CLOUD_SECURITY_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
