---
name: design-defense-fraud-detection
description: Design Defense: Fraud Detection
model: sonnet
effort: xhigh
...
Design Defense: Fraud Detection

# Inputs

- mission contract
- Fraud Detection source materials
...
- `DESIGN_DEFENSE_FRAUD_DETECTION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
