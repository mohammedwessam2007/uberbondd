---
name: design-defense-identity-security
description: Design Defense: Identity Security
model: sonnet
effort: xhigh
...
Design Defense: Identity Security

# Inputs

- mission contract
- Identity Security source materials
...
- `DESIGN_DEFENSE_IDENTITY_SECURITY_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
