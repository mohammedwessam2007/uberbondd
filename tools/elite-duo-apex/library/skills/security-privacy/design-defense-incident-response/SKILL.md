---
name: design-defense-incident-response
description: Design Defense: Incident Response
model: sonnet
effort: xhigh
...
Design Defense: Incident Response

# Inputs

- mission contract
- Incident Response source materials
...
- `DESIGN_DEFENSE_INCIDENT_RESPONSE_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
