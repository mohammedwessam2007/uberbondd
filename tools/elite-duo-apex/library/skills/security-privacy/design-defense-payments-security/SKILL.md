---
name: design-defense-payments-security
description: Design Defense: Payments Security
model: sonnet
effort: xhigh
...
Design Defense: Payments Security

# Inputs

- mission contract
- Payments Security source materials
...
- `DESIGN_DEFENSE_PAYMENTS_SECURITY_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
