---
name: design-defense-prompt-injection
description: Design Defense: Prompt Injection
model: sonnet
effort: xhigh
...
Design Defense: Prompt Injection

# Inputs

- mission contract
- Prompt Injection source materials
...
- `DESIGN_DEFENSE_PROMPT_INJECTION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
