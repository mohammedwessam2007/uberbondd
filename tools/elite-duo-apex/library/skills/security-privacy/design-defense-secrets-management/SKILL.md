---
name: design-defense-secrets-management
description: Design Defense: Secrets Management
model: sonnet
effort: xhigh
...
Design Defense: Secrets Management

# Inputs

- mission contract
- Secrets Management source materials
...
- `DESIGN_DEFENSE_SECRETS_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
