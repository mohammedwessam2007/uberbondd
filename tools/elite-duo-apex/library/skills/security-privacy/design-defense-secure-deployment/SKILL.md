---
name: design-defense-secure-deployment
description: Design Defense: Secure Deployment
model: sonnet
effort: xhigh
...
Design Defense: Secure Deployment

# Inputs

- mission contract
- Secure Deployment source materials
...
- `DESIGN_DEFENSE_SECURE_DEPLOYMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
