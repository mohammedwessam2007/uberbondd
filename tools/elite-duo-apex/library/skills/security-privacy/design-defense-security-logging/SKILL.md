---
name: design-defense-security-logging
description: Design Defense: Security Logging
model: sonnet
effort: xhigh
...
Design Defense: Security Logging

# Inputs

- mission contract
- Security Logging source materials
...
- `DESIGN_DEFENSE_SECURITY_LOGGING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
