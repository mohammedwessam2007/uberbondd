---
name: design-defense-supply-chain-security
description: Design Defense: Supply Chain Security
model: sonnet
effort: xhigh
...
Design Defense: Supply Chain Security

# Inputs

- mission contract
- Supply Chain Security source materials
...
- `DESIGN_DEFENSE_SUPPLY_CHAIN_SECURITY_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
