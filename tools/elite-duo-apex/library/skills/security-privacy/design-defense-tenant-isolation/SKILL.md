---
name: design-defense-tenant-isolation
description: Design Defense: Tenant Isolation
model: sonnet
effort: xhigh
...
Design Defense: Tenant Isolation

# Inputs

- mission contract
- Tenant Isolation source materials
...
- `DESIGN_DEFENSE_TENANT_ISOLATION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
