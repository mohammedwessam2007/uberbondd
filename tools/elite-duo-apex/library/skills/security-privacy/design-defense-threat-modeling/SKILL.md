---
name: design-defense-threat-modeling
description: Design Defense: Threat Modeling
model: sonnet
effort: xhigh
...
Design Defense: Threat Modeling

# Inputs

- mission contract
- Threat Modeling source materials
...
- `DESIGN_DEFENSE_THREAT_MODELING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
