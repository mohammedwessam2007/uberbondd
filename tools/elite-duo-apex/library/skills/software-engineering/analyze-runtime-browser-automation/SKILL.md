---
name: analyze-runtime-browser-automation
description: Analyze Runtime: Browser Automation
model: sonnet
effort: xhigh
...
Analyze Runtime: Browser Automation
...
- `ANALYZE_RUNTIME_BROWSER_AUTOMATION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
