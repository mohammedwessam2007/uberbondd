---
name: analyze-runtime-cloud-architecture
description: Analyze Runtime: Cloud Architecture
model: sonnet
effort: xhigh
...
Analyze Runtime: Cloud Architecture
...
- `ANALYZE_RUNTIME_CLOUD_ARCHITECTURE_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
