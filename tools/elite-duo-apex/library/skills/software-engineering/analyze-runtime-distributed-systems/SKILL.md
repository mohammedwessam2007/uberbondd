---
name: analyze-runtime-distributed-systems
description: Analyze Runtime: Distributed Systems
model: sonnet
effort: xhigh
...
Analyze Runtime: Distributed Systems
...
- `ANALYZE_RUNTIME_DISTRIBUTED_SYSTEMS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
