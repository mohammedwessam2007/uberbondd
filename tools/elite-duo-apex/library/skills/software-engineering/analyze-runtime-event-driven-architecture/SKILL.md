---
name: analyze-runtime-event-driven-architecture
description: Analyze Runtime: Event Driven Architecture
model: sonnet
effort: xhigh
...
Analyze Runtime: Event Driven Architecture
...
- `ANALYZE_RUNTIME_EVENT_DRIVEN_ARCHITECTURE_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
