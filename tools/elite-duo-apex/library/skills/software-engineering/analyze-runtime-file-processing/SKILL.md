---
name: analyze-runtime-file-processing
description: Analyze Runtime: File Processing
model: sonnet
effort: xhigh
...
Analyze Runtime: File Processing
...
- `ANALYZE_RUNTIME_FILE_PROCESSING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
