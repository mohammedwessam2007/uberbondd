---
name: analyze-runtime-frontend-systems
description: Analyze Runtime: Frontend Systems
model: sonnet
effort: xhigh
...
Analyze Runtime: Frontend Systems
...
- `ANALYZE_RUNTIME_FRONTEND_SYSTEMS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
