---
name: analyze-runtime-identity-access
description: Analyze Runtime: Identity Access
model: sonnet
effort: xhigh
...
Analyze Runtime: Identity Access
...
- `ANALYZE_RUNTIME_IDENTITY_ACCESS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
