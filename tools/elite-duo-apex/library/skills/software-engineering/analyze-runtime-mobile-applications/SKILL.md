---
name: analyze-runtime-mobile-applications
description: Analyze Runtime: Mobile Applications
model: sonnet
effort: xhigh
...
Analyze Runtime: Mobile Applications
...
- `ANALYZE_RUNTIME_MOBILE_APPLICATIONS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
