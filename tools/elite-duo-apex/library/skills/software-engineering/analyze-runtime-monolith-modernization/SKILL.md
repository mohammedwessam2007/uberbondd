---
name: analyze-runtime-monolith-modernization
description: Analyze Runtime: Monolith Modernization
model: sonnet
effort: xhigh
...
Analyze Runtime: Monolith Modernization
...
- `ANALYZE_RUNTIME_MONOLITH_MODERNIZATION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
