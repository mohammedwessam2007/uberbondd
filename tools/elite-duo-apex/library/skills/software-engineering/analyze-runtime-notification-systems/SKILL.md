---
name: analyze-runtime-notification-systems
description: Analyze Runtime: Notification Systems
model: sonnet
effort: xhigh
...
Analyze Runtime: Notification Systems
...
- `ANALYZE_RUNTIME_NOTIFICATION_SYSTEMS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
