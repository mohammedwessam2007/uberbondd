---
name: analyze-runtime-package-management
description: Analyze Runtime: Package Management
model: sonnet
effort: xhigh
...
Analyze Runtime: Package Management
...
- `ANALYZE_RUNTIME_PACKAGE_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
