---
name: analyze-runtime-platform-engineering
description: Analyze Runtime: Platform Engineering
model: sonnet
effort: xhigh
...
Analyze Runtime: Platform Engineering
...
- `ANALYZE_RUNTIME_PLATFORM_ENGINEERING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
