---
name: build-durable-change-api-design
description: Build Durable Change: Api Design
model: sonnet
effort: xhigh
...
Build Durable Change: Api Design
...
- `BUILD_DURABLE_CHANGE_API_DESIGN_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
