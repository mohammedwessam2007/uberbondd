---
name: build-durable-change-backend-services
description: Build Durable Change: Backend Services
model: sonnet
effort: xhigh
...
Build Durable Change: Backend Services

# Inputs

- mission contract
- Backend Services source materials
...
- `BUILD_DURABLE_CHANGE_BACKEND_SERVICES_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
