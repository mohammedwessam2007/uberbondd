---
name: build-durable-change-billing-systems
description: Build Durable Change: Billing Systems
model: sonnet
effort: xhigh
...
Build Durable Change: Billing Systems

# Inputs

- mission contract
- Billing Systems source materials
...
- `BUILD_DURABLE_CHANGE_BILLING_SYSTEMS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
