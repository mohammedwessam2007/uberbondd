---
name: build-durable-change-browser-automation
description: Build Durable Change: Browser Automation
model: sonnet
effort: xhigh
...
Build Durable Change: Browser Automation

# Inputs

- mission contract
- Browser Automation source materials
...
- `BUILD_DURABLE_CHANGE_BROWSER_AUTOMATION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
