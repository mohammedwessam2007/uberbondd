---
name: build-durable-change-ci-cd
description: Build Durable Change: Ci Cd
model: sonnet
effort: xhigh
...
Build Durable Change: Ci Cd

# Inputs

- mission contract
- Ci Cd source materials
...
- `BUILD_DURABLE_CHANGE_CI_CD_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
