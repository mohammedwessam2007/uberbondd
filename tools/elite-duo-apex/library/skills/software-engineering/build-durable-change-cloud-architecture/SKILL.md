---
name: build-durable-change-cloud-architecture
description: Build Durable Change: Cloud Architecture
model: sonnet
effort: xhigh
...
Build Durable Change: Cloud Architecture

# Inputs

- mission contract
- Cloud Architecture source materials
...
- `BUILD_DURABLE_CHANGE_CLOUD_ARCHITECTURE_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
