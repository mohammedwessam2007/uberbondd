---
name: build-durable-change-configuration
description: Build Durable Change: Configuration
model: sonnet
effort: xhigh
...
Build Durable Change: Configuration

# Inputs

- mission contract
- Configuration source materials
...
- `BUILD_DURABLE_CHANGE_CONFIGURATION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
