---
name: build-durable-change-data-migrations
description: Build Durable Change: Data Migrations
model: sonnet
effort: xhigh
...
Build Durable Change: Data Migrations

# Inputs

- mission contract
- Data Migrations source materials
...
- `BUILD_DURABLE_CHANGE_DATA_MIGRATIONS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
