---
name: build-durable-change-database-engineering
description: Build Durable Change: Database Engineering
model: sonnet
effort: xhigh
...
Build Durable Change: Database Engineering

# Inputs

- mission contract
- Database Engineering source materials
...
- `BUILD_DURABLE_CHANGE_DATABASE_ENGINEERING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
