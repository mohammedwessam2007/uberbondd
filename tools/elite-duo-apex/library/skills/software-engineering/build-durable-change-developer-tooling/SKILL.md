---
name: build-durable-change-developer-tooling
description: Build Durable Change: Developer Tooling
model: sonnet
effort: xhigh
...
Build Durable Change: Developer Tooling

# Inputs

- mission contract
- Developer Tooling source materials
...
- `BUILD_DURABLE_CHANGE_DEVELOPER_TOOLING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
