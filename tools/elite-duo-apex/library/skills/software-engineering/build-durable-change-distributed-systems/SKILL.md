---
name: build-durable-change-distributed-systems
description: Build Durable Change: Distributed Systems
model: sonnet
effort: xhigh
...
Build Durable Change: Distributed Systems

# Inputs

- mission contract
- Distributed Systems source materials
...
- `BUILD_DURABLE_CHANGE_DISTRIBUTED_SYSTEMS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
