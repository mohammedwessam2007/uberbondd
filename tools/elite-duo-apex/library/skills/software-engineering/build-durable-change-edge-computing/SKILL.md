---
name: build-durable-change-edge-computing
description: Build Durable Change: Edge Computing
model: sonnet
effort: xhigh
...
Build Durable Change: Edge Computing

# Inputs

- mission contract
- Edge Computing source materials
...
- `BUILD_DURABLE_CHANGE_EDGE_COMPUTING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
