---
name: build-durable-change-event-driven-architecture
description: Build Durable Change: Event Driven Architecture
model: sonnet
effort: xhigh
...
Build Durable Change: Event Driven Architecture

# Inputs

- mission contract
- Event Driven Architecture source materials
...
- `BUILD_DURABLE_CHANGE_EVENT_DRIVEN_ARCHITECTURE_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
