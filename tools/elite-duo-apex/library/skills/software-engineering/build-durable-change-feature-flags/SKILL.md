---
name: build-durable-change-feature-flags
description: Build Durable Change: Feature Flags
model: sonnet
effort: xhigh
...
Build Durable Change: Feature Flags

# Inputs

- mission contract
- Feature Flags source materials
...
- `BUILD_DURABLE_CHANGE_FEATURE_FLAGS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
