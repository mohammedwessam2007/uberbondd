---
name: build-durable-change-file-processing
description: Build Durable Change: File Processing
model: sonnet
effort: xhigh
...
Build Durable Change: File Processing

# Inputs

- mission contract
- File Processing source materials
...
- `BUILD_DURABLE_CHANGE_FILE_PROCESSING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
