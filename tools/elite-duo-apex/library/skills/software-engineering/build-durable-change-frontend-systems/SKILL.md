---
name: build-durable-change-frontend-systems
description: Build Durable Change: Frontend Systems
model: sonnet
effort: xhigh
...
Build Durable Change: Frontend Systems

# Inputs

- mission contract
- Frontend Systems source materials
...
- `BUILD_DURABLE_CHANGE_FRONTEND_SYSTEMS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
