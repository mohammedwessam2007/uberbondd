---
name: build-durable-change-identity-access
description: Build Durable Change: Identity Access
model: sonnet
effort: xhigh
...
Build Durable Change: Identity Access

# Inputs

- mission contract
- Identity Access source materials
...
- `BUILD_DURABLE_CHANGE_IDENTITY_ACCESS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
