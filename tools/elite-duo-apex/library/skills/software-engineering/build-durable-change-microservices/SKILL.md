---
name: build-durable-change-microservices
description: Build Durable Change: Microservices
model: sonnet
effort: xhigh
...
Build Durable Change: Microservices

# Inputs

- mission contract
- Microservices source materials
...
- `BUILD_DURABLE_CHANGE_MICROSERVICES_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
