---
name: build-durable-change-mobile-applications
description: Build Durable Change: Mobile Applications
model: sonnet
effort: xhigh
...
Build Durable Change: Mobile Applications

# Inputs

- mission contract
- Mobile Applications source materials
...
- `BUILD_DURABLE_CHANGE_MOBILE_APPLICATIONS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
