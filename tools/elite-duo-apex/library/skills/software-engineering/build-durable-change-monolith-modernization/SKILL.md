---
name: build-durable-change-monolith-modernization
description: Build Durable Change: Monolith Modernization
model: sonnet
effort: xhigh
...
Build Durable Change: Monolith Modernization

# Inputs

- mission contract
- Monolith Modernization source materials
...
- `BUILD_DURABLE_CHANGE_MONOLITH_MODERNIZATION_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
