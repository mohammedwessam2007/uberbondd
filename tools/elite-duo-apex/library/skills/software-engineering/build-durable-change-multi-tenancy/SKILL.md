---
name: build-durable-change-multi-tenancy
description: Build Durable Change: Multi Tenancy
model: sonnet
effort: xhigh
...
Build Durable Change: Multi Tenancy

# Inputs

- mission contract
- Multi Tenancy source materials
...
- `BUILD_DURABLE_CHANGE_MULTI_TENANCY_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
