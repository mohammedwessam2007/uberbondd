---
name: build-durable-change-notification-systems
description: Build Durable Change: Notification Systems
model: sonnet
effort: xhigh
...
Build Durable Change: Notification Systems

# Inputs

- mission contract
- Notification Systems source materials
...
- `BUILD_DURABLE_CHANGE_NOTIFICATION_SYSTEMS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
