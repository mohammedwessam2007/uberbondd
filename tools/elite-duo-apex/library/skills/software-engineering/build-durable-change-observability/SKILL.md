---
name: build-durable-change-observability
description: Build Durable Change: Observability
model: sonnet
effort: xhigh
...
Build Durable Change: Observability

# Inputs

- mission contract
- Observability source materials
...
- `BUILD_DURABLE_CHANGE_OBSERVABILITY_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
