---
name: build-durable-change-package-management
description: Build Durable Change: Package Management
model: sonnet
effort: xhigh
...
Build Durable Change: Package Management

# Inputs

- mission contract
- Package Management source materials
...
- `BUILD_DURABLE_CHANGE_PACKAGE_MANAGEMENT_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
