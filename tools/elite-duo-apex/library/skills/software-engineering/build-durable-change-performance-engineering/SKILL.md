---
name: build-durable-change-performance-engineering
description: Build Durable Change: Performance Engineering
model: sonnet
effort: xhigh
...
Build Durable Change: Performance Engineering

# Inputs

- mission contract
- Performance Engineering source materials
...
- `BUILD_DURABLE_CHANGE_PERFORMANCE_ENGINEERING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
