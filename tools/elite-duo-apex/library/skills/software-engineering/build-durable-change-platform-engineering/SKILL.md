---
name: build-durable-change-platform-engineering
description: Build Durable Change: Platform Engineering
model: sonnet
effort: xhigh
...
Build Durable Change: Platform Engineering

# Inputs

- mission contract
- Platform Engineering source materials
...
- `BUILD_DURABLE_CHANGE_PLATFORM_ENGINEERING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
