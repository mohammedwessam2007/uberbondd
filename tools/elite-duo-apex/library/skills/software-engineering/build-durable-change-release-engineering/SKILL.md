---
name: build-durable-change-release-engineering
description: Build Durable Change: Release Engineering
model: sonnet
effort: xhigh
...
Build Durable Change: Release Engineering

# Inputs

- mission contract
- Release Engineering source materials
...
- `BUILD_DURABLE_CHANGE_RELEASE_ENGINEERING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
