---
name: build-durable-change-reliability-engineering
description: Build Durable Change: Reliability Engineering
model: sonnet
effort: xhigh
...
Build Durable Change: Reliability Engineering

# Inputs

- mission contract
- Reliability Engineering source materials
...
- `BUILD_DURABLE_CHANGE_RELIABILITY_ENGINEERING_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
