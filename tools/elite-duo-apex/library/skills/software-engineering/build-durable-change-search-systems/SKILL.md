---
name: build-durable-change-search-systems
description: Build Durable Change: Search Systems
model: sonnet
effort: xhigh
...
Build Durable Change: Search Systems

# Inputs

- mission contract
- Search Systems source materials
...
- `BUILD_DURABLE_CHANGE_SEARCH_SYSTEMS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
