---
name: build-durable-change-serverless
description: Build Durable Change: Serverless
model: sonnet
effort: xhigh
...
Build Durable Change: Serverless

# Inputs

- mission contract
- Serverless source materials
...
- `BUILD_DURABLE_CHANGE_SERVERLESS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
