---
name: build-durable-change-testing-systems
description: Build Durable Change: Testing Systems
model: sonnet
effort: xhigh
...
Build Durable Change: Testing Systems

# Inputs

- mission contract
- Testing Systems source materials
...
- `BUILD_DURABLE_CHANGE_TESTING_SYSTEMS_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
