---
name: build-durable-change-workflow-engines
description: Build Durable Change: Workflow Engines
model: sonnet
effort: xhigh
...
Build Durable Change: Workflow Engines

# Inputs

- mission contract
- Workflow Engines source materials
...
- `BUILD_DURABLE_CHANGE_WORKFLOW_ENGINES_RESULT.json`
- `EVIDENCE.md`
- `LIMITATIONS.md`
